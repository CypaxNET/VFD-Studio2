/*!
 * @brief         Arduino driver for GP1287 CFD
 * 
 ...
 *                GP1287 VFD (EVG256x48/50 200AP-c).
 *                (See also https://www.hackster.io/mircemk/simple-esp8266-ntp-clock-on-vfd-display-vfd256x50-gp1287-e0187a)
...
{
  u8g2.clear();
  for (uint16_t y = 0; y < (u8g2.getDisplayHeight()/8); y++) // for each row
  {
    for(uint16_t x = 0; x < u8g2.getDisplayWidth(); x++) // for each x position
    {
