...
OutFile "vfdstudio-installer_${BUNDLEVERSION_HYPENATED}_32bit.exe"
...
!define MUI_WELCOMEPAGE_TITLE  "VFD-Studio ${BUNDLEVERSION_NOQUOTES} 32 bit Setup"

!define MUI_WELCOMEPAGE_TEXT  "Setup will install VFD-Studio version ${BUNDLEVERSION_NOQUOTES} (32bit).$\r$\n$\r$\nCheck the GitHub project page from the link below for newer versions.$\r$\n$\r$\nClick Next to continue."
...
Section "Program files (Required)"  SecPrg
  ...
  File "/oname=VFDStudio2.exe" "..\vfdstudio\VFDStudio2_32bit.exe"
  File "/oname=ListEditor.exe" "..\vfdstudio\ListEditor_32bit.exe"
