...
const
  STUDIO_COMMANDS = 'INCLUDE NEWSCREEN ENDSCREEN CLEARSCREEN SCREENTIME STOP ORMODE XORMODE ANDMODE LIGHT PLAINTEXT TEXTOUT BITMAP ANIMATE PIXEL LINE FRAME NOISE CLOCK DRIVEUSAGE RAMMONITOR CPUMONITOR MATRIX WAPLAYBAR';
  ...
  STUDIO_KEYWORDS_VARIABLE = 'TOTALDRIVE FREEDRIVE DRIVEUSE NAMEDRIVE MEMORY FREEMEM MEMUSAGE AVERAGECPU CPUUSAGE IP UPTIME CPUSPEED RES COLORS FREQ WAVERSION WATITLE WALENGTH WAPOS DOW DATE TIME YEAR MON DAY HH MM SS : OHM LHM';
