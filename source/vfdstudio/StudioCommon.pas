...
const
  ...
  STUDIO_KEYWORDS_VARIABLE = 'TOTALDRIVE FREEDRIVE NAMEDRIVE MEMORY FREEMEM MEMUSAGE AVERAGECPU CPUUSAGE IP UPTIME CPUSPEED RES COLORS FREQ WAVERSION WATITLE WALENGTH WAPOS DOW DATE TIME YEAR MON DAY HH MM SS : OHM';
