...
const
  STUDIO_COMMANDS = 'NEWSCREEN SCREENEND CLEARSCREEN SCREENTIME STOP ORMODE XORMODE ANDMODE LIGHT PLAINTEXT TEXTOUT BITMAP ANIMATE PIXEL LINE FRAME NOISE CLOCK DRIVEUSAGE RAMMONITOR CPUMONITOR THEMATRIX';
