...
const
  STUDIO_COMMANDS = 'NEWSCREEN ENDSCREEN CLEARSCREEN SCREENTIME STOP ORMODE XORMODE ANDMODE LIGHT PLAINTEXT TEXTOUT BITMAP ANIMATE PIXEL LINE FRAME NOISE CLOCK DRIVEUSAGE RAMMONITOR CPUMONITOR MATRIX WAPLAYBAR';
