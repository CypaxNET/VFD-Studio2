  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (assigned(FPreviewDisplay)) then begin
...
var
  ...
  TmpBitmap: TBitmap;
begin
  if (not assigned(FPreviewDisplay)) then
    Exit;
      ...
      begin
        ...
        begin
          ...
          try
            ...
            FPreviewDisplay.GraphicsLayer.Canvas.Draw(P3, P4, TmpBitmap);
            FPreviewDisplay.CombineVirtualLayers(PreviewImage.Picture.Bitmap);
