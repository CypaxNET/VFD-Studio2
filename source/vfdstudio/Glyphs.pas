...
const
  ...
  charMap8x6: array[0..255, 0..5] of Byte =
    ...
    ($02, $04, $08, $10, $20, $00),  // 5C (backslash)
    ...
    ($38, $54, $56, $55, $58, $00),  // C6 é
    ($38, $55, $56, $54, $58, $00),  // C7 è
    ($00, $00, $00, $00, $00, $00),  // C8 ê
    ($00, $00, $00, $00, $00, $00),  // C9
    ($00, $00, $00, $01, $00, $00),  // CA í
    ($00, $01, $7A, $00, $00, $00),  // CB ì
    ...
    ($00, $00, $00, $00, $00, $00),  // D9 (British Pound)
    ...
    ($00, $00, $00, $00, $00, $00),  // EF (backslash lines)
...
begin
  ...
  R := R.Replace('í', Chr($CA), [rfReplaceAll]);
  R := R.Replace('ì', Chr($CB), [rfReplaceAll]);

  R := R.Replace('é', Chr($C6), [rfReplaceAll]);
  R := R.Replace('è', Chr($C7), [rfReplaceAll]);
